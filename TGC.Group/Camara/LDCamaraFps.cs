...
{
    public class LDCamaraFps : TgcCamera
    {
        ...
        public void captureMouse()
        {
            ...
            int ScreenWidth = d3dDevice.Viewport.Width;
            int ScreenHeight = d3dDevice.Viewport.Height;
            int ScreenX = d3dDevice.Viewport.X;
            int ScreenY = d3dDevice.Viewport.Y;
